// WHAT `Esc` AND `B` DO TO A STAGE MESSAGE — ratified, not inherited.
//
...
describe('a Stage Message outlives a panic control, deliberately', () => {
  ...
  it('and the Stage Note, which rides with the content, still goes', async () => {
