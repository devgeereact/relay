...
cd src-tauri
cargo test                                   # 639 tests (621 run, 18 ignored)
...
**621 Rust** (18 ignored) + **871 frontend** (0 skipped), re-measured 2026-08-30. CI runs both on **macOS and Windows**, plus `fmt`, `clippy -D warnings`, the detection scorecard, and a release build.
