...
cd src-tauri
cargo test                                   # 644 tests (627 run, 17 ignored)
cargo test e2e                               # the fire → nav → clear path (38 tests, 0 ignored)
