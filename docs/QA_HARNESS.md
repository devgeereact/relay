...
|---|---|---|
| Rust tests | **628 passing**, 17 ignored (645 declared) | `cd src-tauri && cargo test` |
| Frontend tests | **925 passing**, 0 skipped, 68 files | `npx vitest run` — read the runner's own summary line. **Not** `vitest list \| wc -l`: that stream carries Svelte compiler warnings too and over-counted by 7 |
