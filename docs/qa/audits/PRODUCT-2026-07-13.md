...
>
> Four relative links in the body (`audits/QA-2026-08-14.md`, `audits/FIELD-2026-08-30.md`,
> `RELAY_GAP.md`, `DECISIONS.md`) were correct from `docs/` and are wrong from here. They resolve
> to [`QA-2026-08-14.md`](QA-2026-08-14.md), [`FIELD-2026-08-30.md`](FIELD-2026-08-30.md),
