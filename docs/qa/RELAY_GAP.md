...
**109 entries. 100 closed, 1 withdrawn as wrong, 8 not closed** — RG-32 open, RG-41 and RG-50
...
**RG-102 … RG-109 were filed and closed on 2026-09-05** — among them **two P0s in the corpus
...
| ✅ **RG-106 · RG-107 · RG-109** | **Also closed 2026-09-05.** The kiosk port gained the handshake deadline, the connection cap and the frame-size limit the HTTP port already had; an imported SVG is no longer served as an active document; and four documented claims that were false against the code were corrected — including a safety table scoring *Preview ≠ Programme* against 17 tests deleted three weeks earlier |
